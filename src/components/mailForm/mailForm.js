      ...
      .then(
        (result) => {
          ...
          document.getElementsByClassName("mailForm_overlay")[0].innerHTML =
            '<p><i className="fas fa-check"></i> Mail Sent</p>';
          document
            .getElementsByClassName("mailForm_overlay")[0]
        ...
        <form ref={form} onSubmit={sendMail}>
          ...
          <div className="sotto">
            <div className="privacy">
              <span>
                By selecting you accept our Privacy Policy. We will not save any
                of your personal details, they will be used only for contact
                purposes.
              </span>
              <br />
            </div>
