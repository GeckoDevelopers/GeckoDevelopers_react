...
export default function Navbar() {
	...
	document.addEventListener('click', function (event) {
		const isClickInsideElement = document.getElementById('languagesMenu').contains(event.target)
		if (!isClickInsideElement) {
			closeMenuLanguages()
		}
	})
	document.addEventListener('click', function (event) {
		const isClickInsideElement = document.getElementById('servicesMenu').contains(event.target)
		if (!isClickInsideElement) {
			closeMenuService()
		}
	})
